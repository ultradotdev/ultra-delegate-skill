...
One independent violation Noul and one evidence-sufficiency Noul are asked per requirement. Defaults are **0.20 / 0.80 / 0.80**, as experimental operating bands. These are not vulnerability severity or task-success probabilities. A flagged or security-sensitive artifact needs independent review before outcome publication. Confirmed critical defects or mandatory requirement violations reject the attempt through existing comparison/repair/fallback recovery. Unresolved concerns need explicit disposition. Unrelated pre-existing vulnerabilities are recorded separately. Technical service failure alone does not fail independently accepted work.
